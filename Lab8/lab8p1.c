...
#define NS_LT_SW PORTAbits.RA1
#define NS_PED_SW PORTAbits.RA3

#define EW_PED_SW PORTAbits.RA4
#define EW_LT_SW PORTAbits.RA2
...
void Wait_N_Seconds (char direction, char seconds)
{
    char I;
    for (I = seconds; I> 0; I--)
    {
